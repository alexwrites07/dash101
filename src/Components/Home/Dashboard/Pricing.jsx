  ...
  const plans = [
    {
      title: 'Basic',
      price: '₹199.00',
      details: ['30 job posting', '3 featured job', 'Job displayed for 15 days', 'Premium Support 24/7'],
      action: 'Add to cart',
    },
    {
      title: 'Standard',
      price: '₹499.00',
      details: ['40 job posting', '5 featured job', 'Job displayed for 30 days', 'Premium Support 24/7'],
      action: 'View cart',
      recommended: true,
    },
    {
      title: 'Extended',
      price: '₹799.00',
      details: ['50 job posting', '10 featured job', 'Job displayed for 60 days', 'Premium Support 24/7'],
      action: 'Add to cart',
    },
  ];
