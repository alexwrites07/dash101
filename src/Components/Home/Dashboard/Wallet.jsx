...
const WalletPage = () => {
  ...
  return (
    <div className="wallet-page min-h-screen max-w-3xl lg:ml-64 py-8 px-4">
      <Sidebar />
    ...
    <div className="balance-card bg-gradient-to-r from-green-400 to-blue-500 text-white rounded-lg p-6 shadow-md mb-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[500, 1000, 2000].map((amount) => (
          <button
            ...
            className="bg-green-500 hover:bg-green-600 text-white font-medium py-3 px-5 rounded-lg shadow transition duration-200"
          >
            Add ₹{amount}
          </button>
        ))}
