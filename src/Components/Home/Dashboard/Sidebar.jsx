...
const Sidebar = ({ activeTab }) => {
  ...
  const sidebarLinks = {
    ...
    tutor: [
      ...
      { to: '/schedule-slot', icon: <HiBriefcase className="w-6 h-6" />, label: 'Schedule' },
      { to: '/resume', icon: <HiDocument className="w-6 h-6" />, label: 'Resume' },
      { to: '/jobpost', icon: <HiClipboard className="w-6 h-6" />, label: 'Jobs' },
      { to: '/needpost', icon: <HiLibrary className="w-6 h-6" />, label: 'Tuitions' },
    ...
    student: [
      ...
      { to: '/learningneeds', icon: <HiBriefcase className="w-6 h-6" />, label: 'Tuitions' },
  ...
  return (
    ...
    <div
      className={`fixed top-24 left-0 w-64 h-screen pt-10 pb-40 bg-white shadow-lg border-r-2 border-gray-200 ${
